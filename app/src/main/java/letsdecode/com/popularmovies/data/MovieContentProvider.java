...
import static letsdecode.com.popularmovies.data.MovieContract.PATH_FAVORITES;

/**
 * Created by aashi on 26/06/17.
 */
...
public class MovieContentProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(MovieContract.CONTENT_AUTHORITY, PATH_FAVORITES, FAVORITE_MOVIES);
        sUriMatcher.addURI(MovieContract.CONTENT_AUTHORITY, PATH_FAVORITES + "/#", FAVORITE_MOVIES_ID);
    }
